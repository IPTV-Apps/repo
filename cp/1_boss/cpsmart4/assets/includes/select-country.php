...
echo '<option value="AX">Aland Islands</option>';
...
echo '<option value="BQ">Bonaire, Sint Eustatius and Saba</option>';
...
echo '<option value="CW">Curacao</option>';
...
echo '<option value="BL">Saint Barthelemy</option>';
...
echo '<option value="MF">Saint Martin</option>';
